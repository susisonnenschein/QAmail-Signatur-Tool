...
function Signature(props) {
  return (
    <div id="signature">
      ...
      <div
        style={{ fontSize: "8pt", fontFamily: "sans-serif", color: "black" }}
      >
        <p style={{ margin: "0pt 1pt 0pt" }}>
          <b>Beste Arbeitgeber ITK 2025 - 1. Platz für QAware</b>
          <br />
          ausgezeichnet von&nbsp;
          <a href="https://www.qaware.de/news/gptw-2025/">
            Great Place to Work
          </a>
        </p>
        <hr
      ...
      <div
        style={{ fontSize: "7pt", fontFamily: "sans-serif", color: "black" }}
      >
        <p style={{ margin: "0pt 1pt 14pt" }}>
          Geschäftsführer: Dr. Josef Adersberger, Mario-Leander Reimer, Michael
          Rohleder, Michael Stehnken
          <br />
...
function App() {
  ...
  function copySignature() {
    copyDataToClipboard(document.getElementById("signature").innerHTML, [
      "text/html",
      "text/plain",
    ]);
  ...
  return (
    <div>
      <div style={{ display: "flex" }}>
        <div
          id="signature-input"
          style={{ border: "1px solid #fec900", borderRadius: "3px" }}
        >
          <div
            style={{
          ...
          <div style={{ padding: "8px" }}>
            <p>
              <label for="user-title" style={{ marginRight: "1em" }}>
                Dein akademischer Titel:
              </label>
              <select
                name="user-title"
                id="user-title"
            ...
            <p>
              <label for="user-location" style={{ marginRight: "1em" }}>
                Dein Standort:
              </label>
              <select
                name="user-location"
        ...
        <div
          ...
          style={{
            marginLeft: "2em",
            border: "1px solid #0593d8",
            borderRadius: "3px",
          }}
        >
          <div
            style={{
              backgroundColor: "#0593d8",
              color: "white",
              padding: "8px",
              fontWeight: "bold",
            }}
